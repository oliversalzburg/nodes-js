function e(r2) {
  ...
  return e = function(e2) {
    ...
    return r3 === void 0 ? Promise.resolve({value: e2, done: true}) : t2(r3.apply(this.s, arguments));
  }, throw: function(e2) {
    var r3 = this.s.return;
    return r3 === void 0 ? Promise.reject(e2) : t2(r3.apply(this.s, arguments));
  }}, new e(r2);
}
const r = async (t2, n, i = t2.name, a) => {
  ...
  try {
    for (var y, f = function(r2) {
      var t3, n2, i2, a2 = 2;
      for (typeof Symbol != "undefined" && (n2 = Symbol.asyncIterator, i2 = Symbol.iterator); a2--; ) {
        if (n2 && (t3 = r2[n2]) != null)
          return t3.call(r2);
        if (i2 && (t3 = r2[i2]) != null)
      ...
      e2.kind === "file" ? l.push(e2.getFile().then((r2) => (r2.directoryHandle = t2, r2.handle = e2, Object.defineProperty(r2, "webkitRelativePath", {configurable: true, enumerable: true, get: () => s2})))) : e2.kind !== "directory" || !n || a && a(e2) || o.push(r(e2, n, s2, a));
    }
  } catch (e2) {
    c = true, s = e2;
  } finally {
    try {
      u && f.return != null && await f.return();
    } finally {
      if (c)
        throw s;
    }
